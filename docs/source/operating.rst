[msp-2ed5] Operating Details
====================================

Generated On: 2024-11-01 19:28:05 UTC
...
.. important::
   ...
   **not be valid if your [msp-2ed5] container is NOT running**.

.. tip::
   You must have your [msp-2ed5] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/aanthonylin/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/aanthonylin/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=40545  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='aanthonylin'  \-\-env DOCKERUSERNAME='aanthonylin'  \-\-env MQTTUSERNAME='aanthonylin'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   aanthonylin/msp-2ed5-amd64 (https://hub.docker.com/r/aanthonylin/msp-2ed5-amd64)
...
.. important::
   docker run -d -p 60229:60229 -p 44579:44579 -p 34757:34757 \-\-env TSS=0 \-\-env SOLUTIONNAME=msp-2ed5 \-\-env SOLUTIONDAG=solution_preprocessing_dag-msp-2ed5 \-\-env GITUSERNAME=aanthonylin  \-\-env GITREPOURL=https://github.com/aanthonylin/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=60229  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=44579  \-\-env SOLUTIONVIPERVIZPORT=34757 \-\-env DOCKERUSERNAME='aanthonylin'  \-\-env EXTERNALPORT=40545 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='aanthonylin' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  aanthonylin/msp-2ed5-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=34757
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=60229
...
It can be accessed by entering: http://localhost:44579
...
.. important::
   http://localhost:34757/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=500&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:34757/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:34757/<html file>
...
[msp-2ed5] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/aanthonylin/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/msp-2ed5
...
.. important::
   solution_preprocessing_dag-msp-2ed5
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=60229, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=37975, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=46021, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=43599, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=45899, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37969, HPDEHOST=127.0.1.1, HPDEPORT=35783, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42345

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6634-msp-2ed5,solution_preprocessing_dag-msp-2ed5, python-preprocess-8321-msp-2ed5,solution_preprocessing_dag-msp-2ed5, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
